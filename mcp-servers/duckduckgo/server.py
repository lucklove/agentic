        ...
        if not results:
            ...
            if not _curl_cffi_available():
                message += (
                    ...
                    "(duckduckgo-mcp-server[browser]) enables Chrome TLS "
    ...
    async def _request_curl(self, data: dict) -> str:
        ...
        try:
            ...
            raise RuntimeError(
                ...
                "Install the optional extra: 'duckduckgo-mcp-server[browser]'"
            ) from e
...
class DuckDuckSearchOutput(BaseModel):
    summary: str


class DuckDuckContentOutput(BaseModel):
    content: str
