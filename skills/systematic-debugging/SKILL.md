...
For domain-specific debugging workflows, read the following resource files:

- `references/weekly-test-debugging-workflow.md` -- tracing failures across the
  3-level run nesting in `autonomous/auto-deploy` weekly tests
- `references/argocd-debugging-workflow.md` -- investigating ArgoCD application
  anomalies such as unexpected Sync Status, Health degradations, or
  ComparisonErrors
